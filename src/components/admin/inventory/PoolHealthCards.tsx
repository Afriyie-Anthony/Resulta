  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className={`p-6.5 rounded-3xl border flex flex-col justify-between transition-all shadow-sm ${
            ...
            <div>
              ...
              >
                <p className={`text-4xl sm:text-5xl font-black tracking-tight group-hover:underline ${
                  ...
                  {stats.wassce.available.toLocaleString()} <span className={`text-sm font-extrabold ${isLight ? 'text-slate-600' : 'text-slate-400'}`}>available PINs</span>
                </p>
              </button>
        ...
        <div>
          ...
          <div className={`mt-4 pt-3.5 border-t flex items-center justify-between text-xs font-semibold ${
            ...
            <span>
              Low Stock Alert Trigger: <strong className={isLight ? 'text-slate-950 font-black' : 'text-slate-100 font-black'}>{stats.wassce.threshold} units</strong>
            </span>
            <button
              type="button"
      ...
      <div className={`p-6.5 rounded-3xl border flex flex-col justify-between transition-all shadow-sm relative overflow-hidden ${
            ...
            <div>
              ...
              >
                <p className={`text-4xl sm:text-5xl font-black tracking-tight group-hover:underline ${
                  ...
                  {stats.bece.available.toLocaleString()} <span className="text-sm font-extrabold text-amber-900/80 dark:text-amber-300/60">available PINs</span>
                </p>
              </button>

              <p className={`text-xs mt-1.5 font-black ${isLight ? 'text-amber-950' : 'text-amber-300/90'}`}>
        ...
        <div>
          <div className={`space-y-2.5 pt-4 border-t ${isLight ? 'border-amber-300/80' : 'border-amber-500/20'}`}>
            <div className="flex justify-between text-xs font-extrabold">
              <span className={isLight ? 'text-amber-950 font-black' : 'text-amber-300/80'}>
            ...
            <div className="flex justify-between text-[10px] text-amber-950 dark:text-amber-400 font-black">
              <span>0% (Empty)</span>
